        ...
        <div className="User-row">
          <div className="User-ranking">
            ...
            <div className="User-anime">
              sweetmonia is <span className="User-rancompleted">#305</span>
              ranked by number of
              <span className="User-completed">completed</span>
              anime and spent <span className="User-days">168,6</span>
              days of life to watch <span className="User-days">431</span>
              titles and <span className="User-days">10.174</span> episodes in
               total, making it <span className="User-randays">#203</span>
              place ranked by total lost days. sweetmonia decided that
              <span className="User-titlesdropped">43</span> titles 
              are not worth of watching and give them 
              <span className="User-dropped">dropped</span> status, with
              <span className="User-randropped">#217</span> place in this
              ranking.
            </div>
            <div className="User-manga">
              <span className="User-completed">Completed</span> mangas gave
              sweetmonia <span className="User-rancompleted">#857</span>place 
              in ranking, which is <span className="User-days">795</span> 
              chapters and <span className="User-days">631</span> volumes read.
              sweetmonia didn't finished enough mangas that is
